...
export interface SunmiPrinterPlugin {
     ...
     */
    SetLeftMargin(options: {
        width: number;
    }): Promise<void>;
    /**
     * Set printing area width
     */
    SetPrintingAreaWidth(options: {
        width: number;
    }): Promise<void>;
    /**
     * Get printer mode
     ...
     */
    addListener(eventName: 'onPrinterStatusUpdated', listenerFunc: (event: {
        status: PrinterStatusEventEnum;
        broadcast?: string;
...
export declare enum PrinterStatusEventEnum {
    /**
